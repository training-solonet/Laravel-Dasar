    ...
    <div class="form-container">
        <form action="/siswa/{{$data->id_siswa}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text"  class="form-control" name="kelas_siswa" value="{{$data->kelas_siswa}}"  required>
            </div>
 
            <div class="mb-3">
                <label class="form-label" for="jurusan">Jurusan siswa:</label>
                <input class="form-control" type="text" name="jurusan" value="{{$data->jurusan}}" required> 
            </div>
